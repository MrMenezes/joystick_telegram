...
game = Telegame('950560324:AAEuDC2z4BQLhxqTvdg_tjtqowcFnD6tAMI')
p1 = dict()
p2 = dict()
...
def cmd(msg):
    ...
    if msg['chat']['id'] in p1:
        print(msg['chat']['first_name'] + msg['chat']['last_name'] + ' Player 1: ' + str(command))
        pyautogui.keyDown(p1dict[command])
        time.sleep(0.2)
        pyautogui.keyUp(p1dict[command])
    elif msg['chat']['id'] in p2:
        print(msg['chat']['first_name'] + msg['chat']['last_name'] + ' Player 2: ' + str(command))
...
def p1add(msg):
    if not msg['chat']['id'] in p2:
        p1[msg['chat']['id']] = ""
        print(msg['chat']['first_name'] + msg['chat']['last_name'] + ' Player 1')
@game.private_command('p2')
def p2add(msg):
    if not msg['chat']['id'] in p1:
        p2[msg['chat']['id']] = ""
        print(msg['chat']['first_name'] + msg['chat']['last_name'] + ' Player 2')
